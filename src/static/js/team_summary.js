var app = new Vue({
    ...
    methods: {
        ...
        generateList() {
            ...
            for (let i of sorted_players.slice(-10)) {
                i[1].threat = true;
            };
...
function plot_bubble_xp_own_prior() {
    ...
    var mousemove = function(d) {
        ...
        threat_color = "white";
        if (d[1].squad == true) {
            have_line = '<tr><td class="text-right">Type</td><td>Squad</td></tr>'
            name_color = own_color = "#6fcfd6";
        } else if (d[1].threat == true) {
            have_line = '<tr><td class="text-right">Type</td><td>Threat</td></tr>'
